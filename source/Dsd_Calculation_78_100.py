...
for chunk in chunks:
    ...
    for event_ext in idx_events:
        ...
        try:
            ...
            R_mp = 6 * 10 ** (-4) * math.pi * 8000. * 3.778 * (
            special.gamma(3. + 0.67 + 1.) / (slp_mp ** (3. + 0.67 + 1.)))
            ...
            R_exp = 6 * 10 ** (-4) * math.pi * N_0exp * 3.778 * (
            special.gamma(3. + 0.67 + 1) / (slopexp ** (3. + 0.67 + 1)))
            ...
            eta246 = M4 ** 2. / (M2 * M6)
            shape246 = ((7.0 - 11.0 * eta246) - (eta246 ** 2.0 + 14.0 * eta246 + 1.0) ** 0.5) / (2.0 * (eta246 - 1.0))
            ...
            W_246 = (math.pi / 6.0) * 10 ** (-3.) * N0_246 * (
            special.gamma(shape246 + 4) / (slope246 ** (shape246 + 4)))
            Z_246 = N0_246 * (special.gamma(shape246 + 7) / (slope246 ** (shape246 + 7)))

            ## VELOCIDAD TERMINAL = aD^b

            R_246 = 6 * 10 ** (-4) * math.pi * N0_246 * 3.778 * (
            special.gamma(3. + shape246 + 0.67 + 1) / (slope246 ** (3. + shape246 + 0.67 + 1)))
